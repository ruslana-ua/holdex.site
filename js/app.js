 ...
 */
    ...
    (() => {
        ...
        function initSliders() {
            ...
            if (document.querySelector(".gallery__slider")) {
                ...
                function scrollActiveThumbIntoView() {
                    const activeThumb = document.querySelector(".gallery__thumbs .swiper-slide-thumb-active");
                ...
                function initSwipers() {
                    if (!galleryThumbs) galleryThumbs = new swiper_core_Swiper(".gallery__thumbs", {
                    ...
                    if (!galleryMain) galleryMain = new swiper_core_Swiper(".gallery__slider", {
        ...
        const catalogBtns = document.querySelectorAll(".catalog-view__btn, .favorits-view__btn");
        const catalogWrapper = document.querySelector(".models-catalog__wrapper");
        const favoritsWrapper = document.querySelector(".favorits-list__wrapper");
        const catalogProducts = document.querySelectorAll(".models-catalog__product, .favorits-list__product");
